...
summary_statsitics_function <- function(df_list, stat = "mean") {
  ...
  names(summary) = paste0(stat, "_", c("treat_pre_BP", "treat_post_BP", "treat_diff_BP", "placebo_pre_BP", "placebo_post_BP", "placebo_diff_BP"))
...
summary_function(bp_list)

summary_function(bp_list, stat = "var")

summary_function(bp_list, stat = "sd")

summary_function(bp_list, stat = "min")

summary_function(bp_list, stat = "max")
